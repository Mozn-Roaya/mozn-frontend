 ...
 * identity + role from the backend session, and a Sign out action that clears the
 * session cookie. Permissions are whatever the signed-in account actually holds. */
